...
<head>
    ...
    <r:require modules="jquery_last"/><%-- jQuery is required for Bootstrap! --%>
    <r:require modules="jquery_validate_last"/><%-- jQuery is required for Bootstrap! --%>

    <r:require modules="bootstrap_last"/>
    <r:require modules="kickstart_utils"/>
